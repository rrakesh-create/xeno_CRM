...
export default function AICampaignCreator() {
  ...
  // Debounced Tone Modulator Execution Pipeline
  useEffect(() => {
    if (segmentData) {
    ...
    <div className="max-w-3xl mx-auto p-6 font-sans">
      ...
      {prediction && (
        <div className="bg-amber-50 border border-amber-200 text-amber-900 p-4 rounded-lg mb-4 text-sm shadow-inner">
          ...
          <span className="text-xs text-amber-600 italic block mt-1">Estimates are based on historical segment behavior benchmarks. Future revenue yields are non-guaranteed.</span>
        </div>
      )}
